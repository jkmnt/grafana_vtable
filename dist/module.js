...
function build_all() {
  ...
  var transparent_opts = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, normal_opts), {
    panel_bg: theme.colors.dashboardBg
  });

  return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, build_classes(build_vstyle(normal_opts), 'panel__grid')), build_classes(build_hstyle(normal_opts), 'panel__grid--horizontal')), build_classes(build_vstyle(transparent_opts), 'panel--transparent__grid')), build_classes(build_hstyle(transparent_opts), 'panel--transparent__grid--horizontal'));
}
...
var CLASSES = build_all();
function get_style(horizontal, transparent) {
  var prefix = "panel" + (transparent ? '--transparent' : '') + "__grid" + (horizontal ? '--horizontal' : '');
  return {
    grid: CLASSES[prefix],
...
function create_gridgroups(gss, options, ctx, aligns) {
  var field_style = function field_style(field_idx, is_dimension) {
    ...
    return options.is_horizontal ? {
      ...
      get_valuealign: function get_valuealign(i) {
        return aligns[field_idx];
      }
    } : {
      nameclass: fieldstyle.nameclass,
      namealign: aligns[0],
...
function VTable(_a) {
  ...
  var style = Object(_styles__WEBPACK_IMPORTED_MODULE_7__["get_style"])(options.is_horizontal, transparent);
