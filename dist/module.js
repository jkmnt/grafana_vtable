...
function VGrid(groups, opts) {
  ...
  groups.forEach(function (g) {
    ...
    if (g.label) {
      var labelcell = react__WEBPACK_IMPORTED_MODULE_1___default.a.cloneElement(g.label, {
        style: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, (_a = g.label.props) === null || _a === void 0 ? void 0 : _a.style), {
          'grid-row': "" + (row + 1),
          'grid-column': "1/-1"
        })
      });
    ...
    g.fields.forEach(function (f) {
      var fieldcells = f.values.map(function (v, i) {
        var _a, _b;

        return react__WEBPACK_IMPORTED_MODULE_1___default.a.cloneElement(v, Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({
          style: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, (_a = v.props) === null || _a === void 0 ? void 0 : _a.style), {
            'grid-row': "" + (row + 1),
            'grid-column': "" + (i + 1)
          })
        }, (_b = opts === null || opts === void 0 ? void 0 : opts.colattrs) === null || _b === void 0 ? void 0 : _b[i]));
      });
...
function HGrid(groups, opts) {
  ...
  var cells = [];
  var fields_startrow = groups.some(function (g) {
    return g.label;
  }) ? 1 : 0;
  var col = 0;
  ...
  groups.forEach(function (g) {
    ...
    if (g.label) {
      var cell = react__WEBPACK_IMPORTED_MODULE_1___default.a.cloneElement(g.label, {
        style: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, (_a = g.label.props) === null || _a === void 0 ? void 0 : _a.style), {
          'grid-row': '1',
    ...
    g.fields.forEach(function (f) {
      ...
      var attrs = (_a = opts === null || opts === void 0 ? void 0 : opts.colattrs) === null || _a === void 0 ? void 0 : _a[col];
      var fields = f.values.map(function (v, i) {
        var _a;
...
function build_all() {
  ...
  var container = Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(COMMON.scrollbars, Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(templateObject_18 || (templateObject_18 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n        overflow: auto;\n        --panel_bg: ", ";\n        --dim: ", ";\n        --hl: ", ";\n        --border_bg: ", ";\n        --header_bg: ", ";\n        &[data-is_transparent] {\n            --panel_bg: ", ";\n        }\n        "], ["\n        overflow: auto;\n        --panel_bg: ", ";\n        --dim: ", ";\n        --hl: ", ";\n        --border_bg: ", ";\n        --header_bg: ", ";\n        &[data-is_transparent] {\n            --panel_bg: ", ";\n        }\n        "])), opts.panel_bg, opts.dim, opts.hl, opts.border_bg, opts.header_bg, opts.dash_bg)); // fit-content should fix the horizontal sticky

  var grid = Object(emotion__WEBPACK_IMPORTED_MODULE_2__["css"])(templateObject_19 || (templateObject_19 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"])(["\n        width: fit-content;\n    "], ["\n        width: fit-content;\n    "])));
  return {
